...
* **空間坐標**：`GCP 5` 站體核心 (`24.7891000°N, 121.0228000°E`, Local ENU `[E: +184.55, N: +803.70, U: 0.0]`)，走向對齊鐵路廊道軸線 (`yaw = -0.2257 rad`)。
* **建築量體與結構**：
...
* **站前迎賓廣場與計程車排班彎道 (`xinzhuang_station_plaza`)**：
  * 鋪設 $42\text{m} \times 26\text{m}$ 灰色花崗岩地磚廣場，包含綠化植栽花台與車站門前旗桿座。
...
* **空間坐標**：橫跨關新路主幹道上方 ($s = 803.7\text{m}$，中心 `[E: +179.84, N: +783.32, U: 0.0]`)。
* **工程與物理規格**：
