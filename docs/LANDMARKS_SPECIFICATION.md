...
* **空間坐標**：`GCP 5` 站體核心 (依真實地圖校準 Local ENU `[E: +148.81, N: +648.14, U: 0.0]`)，走向對齊鐵路廊道軸線 (`yaw = -0.2257 rad`)。車站正門朝南，唯一與關新路直接連通。
* **建築量體與結構**：
...
* **站前迎賓廣場與計程車排班避車道 (`xinzhuang_station_plaza`)**：
  * 鋪設 $36\text{m} \times 24\text{m}$ 灰色花崗岩地磚廣場 (`[E: +143.66, N: +625.72, U: 0.075, yaw = -0.2257 rad]`)，包含綠化植栽花台與車站門前旗桿座，正對關新路直道北端點 ($s = 630\text{m}$)。
...
* **空間坐標**：位於新莊車站西側高架鐵路廊道上方 (中心 `[E: +114.69, N: +655.97, U: 0.0]`, `yaw = -0.2257 rad`)，東西向橫貫，無縫銜接車站月台箱梁。
* **工程與物理規格**：
